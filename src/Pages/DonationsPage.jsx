...
import Img3 from '../assets/Images/drumming.jpg';
                  ...
                  <Card className='mb-5 dCard1'>
                    ...
                    <div className='mx-5 mt-4 mb-2'>
                      ...
                      <ul className='list-unstyled dCard1-list '>
                        <li classNa me='fw-bold fs-5' style={{color:"#6e385dff"}}>$380.00</li>
